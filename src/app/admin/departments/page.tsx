    ...
    <div className="bg-gray-50 p-6 space-y-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Manage organizational departments within divisions</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50">
                ...
                <th className="text-xs font-medium text-gray-500 uppercase tracking-wider px-4 py-3 text-left">Sections</th>
            ...
            <tbody className="divide-y divide-gray-100">
              {departments.map((department) => (
                <tr key={department.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{department.division.name}</td>
                  <td className="px-4 py-3 text-sm text-gray-600">{department._count?.sections || 0}</td>
